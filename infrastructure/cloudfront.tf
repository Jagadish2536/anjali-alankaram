...
function handler(event) {
    ...
    headers['content-security-policy'] = {
        value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://www.googletagmanager.com https://accounts.google.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://accounts.google.com; img-src 'self' data: https://*.cloudfront.net https://*.s3.ap-south-2.amazonaws.com https://*.s3.amazonaws.com https://*.amazonaws.com https://*.googleusercontent.com; connect-src 'self' https://api.openai.com https://checkout.razorpay.com https://www.google-analytics.com https://accounts.google.com https://*.googleapis.com; frame-src 'self' https://api.razorpay.com https://checkout.razorpay.com https://accounts.google.com; media-src 'self' https://*.s3.ap-south-2.amazonaws.com https://*.s3.amazonaws.com https://*.amazonaws.com https://*.cloudfront.net;"
    };
