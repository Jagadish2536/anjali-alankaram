  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        ...
        { name = "SES_AWS_ACCESS_KEY_ID", valueFrom = "${var.secrets_arn}:SES_AWS_ACCESS_KEY_ID::" },
        { name = "SES_AWS_SECRET_ACCESS_KEY", valueFrom = "${var.secrets_arn}:SES_AWS_SECRET_ACCESS_KEY::" },
        { name = "SES_AWS_REGION", valueFrom = "${var.secrets_arn}:SES_AWS_REGION::" },
