        ...
        .then(user => {
          if (user?.email) {
            this.emailService.sendOrderConfirmation(user.email, {
              ...
              couponDiscount: Number(order.discountAmount),
              offerTitle: order.offerTitle || undefined,
              offerDiscount: Number(order.offerDiscount),
              platformFee: Number(order.platformFee),
              codCharges: Number(order.codCharges),
              giftCharge: Number(order.giftCharge),
