...
export default function CheckoutPage() {
  ...
  const { items, subtotal, removeItem, updateItem, fetchCart, clearCart } = useCartStore();
  ...
  const total = subtotal - couponDiscount + shipping + platformFee + codFee + gstAmount + giftFee;
            ...
            <div className="p-4 space-y-3 text-sm">
              ...
              {couponDiscount > 0 && (
                <div className="bg-green-50 border border-green-100 rounded-lg px-3 py-2 flex items-center gap-2">
                  ...
                  <p className="text-xs text-green-700 font-bold">You save {formatPrice(couponDiscount)} on this order!</p>
                </div>
              )}
